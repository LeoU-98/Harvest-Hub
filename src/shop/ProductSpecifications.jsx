    ...
    <div className="w-full bg-white p-4 lg:w-1/2 xl:w-3/5">
      <div className="">
        ...
        <div className="mb-2">
          ...
          <a className="hover:text-apple-500 text-gray-700">1 reviews </a>
          <a className="hover:text-apple-500 text-gray-700">Write a review</a>
        </div>
        <div>
          <span className="text-sm text-gray-800 line-through">$26.60</span>
          <div className="flex items-center gap-4">
            <span className="text-apple-500 flex items-center justify-center text-2xl">
              $100
            </span>
            <span className="bg-apple-500 flex h-fit items-center justify-center px-1 py-[2px] text-[12px] font-bold text-white">
              Save 20%
            </span>
          </div>
        </div>
      ...
      <div>
        ...
        <div className="mb-4">
          ...
          >
            ...
            <span className="hover:text-apple-500 inline-block text-sm text-gray-700">
              Add to Wishlist
            </span>
          </a>
        </div>
