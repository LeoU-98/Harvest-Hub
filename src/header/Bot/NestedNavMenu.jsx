...
const megaMenuData = [
  {
    categoryItem: "bot.storeLinks.agri.secHeader",
    categoryLink: "products/agricultural-products",
    items: [
      {
        itemTitle: "bot.storeLinks.agri.sec1",
        itemLink: "products/crop-fresh-produce",
      },
      {
        itemTitle: "bot.storeLinks.agri.sec2",
        itemLink: "products/seeds-and-saplings",
      },
      {
        itemTitle: "bot.storeLinks.agri.sec3",
        itemLink: "products/dairy-and-livestock",
      },
    ],
  },
  {
    categoryItem: "bot.storeLinks.tech.secHeader",
    categoryLink: "products/farming-technology",
    items: [
      {
        itemTitle: "bot.storeLinks.tech.sec1",
        itemLink: "products/soil-and-crop-monitoring",
      },
      {
        itemTitle: "bot.storeLinks.tech.sec2",
        itemLink: "products/crop-spraying-equipment",
      },
      {
        itemTitle: "bot.storeLinks.tech.sec3",
        itemLink: "products/storage-and-processing ",
      },
    ],
  },
